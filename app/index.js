...
var app = new Vue({
	...
	methods: {
		refreshAppts: function () {
			var self = this
			return fetch('https://ihs1.herokuapp.com/irvine/appointments', {
				method: 'POST',
				headers: {
		...
		login: function () {
			...
			this.isLoading = true
			var problem = false
			fetch('https://ihs1.herokuapp.com/irvine/appointments', {
				method: 'POST',
				headers: {
					'Accept': 'application/json',
					'Content-Type': 'application/json'
			...
			fetch('https://ihs1.herokuapp.com/irvine/offerings', {
				method: 'POST',
				headers: {
					'Accept': 'application/json',
					'Content-Type': 'application/json'
			...
			fetch('https://ihs1.herokuapp.com/irvine/teachers')
				.then(res => res.json())
				.then(obj => {
		...
		createOfferingAppt: function () {
			...
			var self = this
			this.isLoading = true
			fetch('https://ihs1.herokuapp.com/irvine/makeAppointment', {
				method: 'POST',
				headers: {
					'Accept': 'application/json',
					'Content-Type': 'application/json'
		...
		deleteAppointment: function (appt) {
			...
			if (appt.teacherEvent === 1) {
				...
				fetch('https://ihs1.herokuapp.com/irvine/deleteAppointment', {
					method: 'POST',
					headers: {
						'Accept': 'application/json',
						'Content-Type': 'application/json'
